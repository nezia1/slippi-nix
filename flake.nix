{
  ...
  in {
    ...
    packages = genPkgs (pkgs: let
      inherit (pkgs) lib;
      slippi-launcher-unwrapped = pkgs.callPackage ./packages/slippi-launcher-unwrapped.nix {};
    in
      lib.fix (self: {
        ...
        slippi-launcher = pkgs.callPackage ./packages/slippi-launcher.nix {
          inherit slippi-launcher-unwrapped;
          inherit (self) slippi-netplay slippi-playback;
        };
      }));
